...
namespace CensusAnalyserTestLive
{
    class CensusAnalyserTest
    {
        ...
        static readonly string indianStateCodeFilePath = @"C:\Users\Snehil\source\repos\CensusAnalyserTestLive\CSVFiles\IndiaStateCode.csv";
        static readonly string indianStateWrongFilePath = @"WrongIndiaStateCodeData.csv";
        static readonly string indianStateWrongTypeFilePath = @"C:\Users\Snehil\source\repos\CensusAnalyserTestLive\CSVFiles\IndiaStateCode.txt";
        static readonly string indianStateIncorrectDelimiterFilePath = @"C:\Users\Snehil\source\repos\CensusAnalyserTestLive\CSVFiles\DelimiterIndiaStateCode.csv";
        static readonly string indianStateIncorrectHeaderFilePath = @"C:\Users\Snehil\source\repos\CensusAnalyserTestLive\CSVFiles\WrongIndiaStateCode.csv";
