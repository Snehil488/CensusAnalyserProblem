...
namespace CensusAnalyserTestLive
{
    class CensusAnalyserTest
    {
        ...
        static readonly string indianStateCensusFilePath = @"C:\Users\Snehil\source\repos\CensusAnalyserTestLive\CSVFiles\IndiaStateCensusData.csv";
        static readonly string indianStateWrongFilePath = @"WrongIndiaStateCensusData.csv";
        static readonly string indianStateWrongTypeFilePath = @"C:\Users\Snehil\source\repos\CensusAnalyserTestLive\CSVFiles\IndiaStateCensusData.txt";
        static readonly string indianStateIncorrectDelimiterFilePath = @"C:\Users\Snehil\source\repos\CensusAnalyserTestLive\CSVFiles\DelimiterIndiaStateCensusData.csv";
        static readonly string indianStateIncorrectHeaderFilePath = @"C:\Users\Snehil\source\repos\CensusAnalyserTestLive\CSVFiles\WrongIndiaStateCensusData.csv";
